...
#define FAIL_IF_NEG(x) if ((ret = (x)) < 0) { goto fail; }
	...
	unsigned char fw_descr[68] = {
		0x56, 0x4D, 0x58, 0x30, 0x30, 0x06, 0x12, 0x20, 0x00, 0x00, 0x5E, 0x00, 0x00, 0x00, 0x12, 0x20, 
		0xCE, 0xFA, 0xBE, 0xBA, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x48, 0x00, 0x00, 0x00, 0x00, 0x00,
